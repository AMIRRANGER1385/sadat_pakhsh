...
if(strtolower($_SERVER['HTTP_HOST']??'')!==$expected){
 if(in_array($_SERVER['REQUEST_METHOD']??'GET',['GET','HEAD'],true)){
  ...
  header('Location: '.rtrim(config('app_url'),'/').$request,true,301);exit;
 }
