...
if($_SERVER['REQUEST_METHOD']==='POST'){
 ...
 try {
  ...
  transaction(function()use($username,$password){
   ...
   query("INSERT INTO ns_settings(id,company_about,company_address,company_phone,company_email) VALUES (1,'','تهران، مجتمع تجریشی','09190385078','info@sadatpakhsh.ir') ON DUPLICATE KEY UPDATE id=id");
