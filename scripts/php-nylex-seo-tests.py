...
with sync_playwright() as p:
 ...
 for path,h1 in [('/products','فروش خرد نایلکس و محصولات پلاستیکی'),('/wholesale','خرید عمده نایلکس مستقیم از تولیدکننده'),('/nylex-manufacturer','تولیدکننده نایلکس و فروش مستقیم')]:
 ...
 page.goto(BASE+'/nylex');expect(page).to_have_url(BASE+'/products')
